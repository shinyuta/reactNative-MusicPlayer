...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(songs)` | `/(tabs)` | `/_sitemap` | `/artists` | `/components/FloatingPlayer` | `/components/PlayerControls` | `/components/TrackListItem` | `/components/TracksList` | `/favorites` | `/playlists`;
