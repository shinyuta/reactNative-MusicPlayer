...
with_node \
  ...
  --target "/Users/yutakirihara/Desktop/projects/music-player/ios/Pods/Target Support Files/Pods-musicplayer/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-asset" "expo-blur" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linear-gradient" "expo-router" "react-native-image-colors"
