import type { ColorValue, processColor, StyleProp, ViewStyle } from 'react-native';
import type * as React from 'react';
export declare type NativeActionEvent = {
    nativeEvent: {
        event: string;
    };
};
declare type MenuAttributes = {
    /**
 ...
 */
declare type MenuState = 'off' | 'on' | 'mixed';
...
declare type MenuComponentPropsBase = {
...
export declare type MenuComponentProps = React.PropsWithChildren<MenuComponentPropsBase>;
...
export declare type NativeMenuComponentProps = {
    style?: StyleProp<ViewStyle>;
    onPressAction?: ({ nativeEvent }: NativeActionEvent) => void;
